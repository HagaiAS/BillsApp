 ...
 */
Ext.define('BillsApp.controller.Facebook', {
    ...
    onFacebookInit: function() {
        ...
        if (BillsApp.app.facebookAppId === '') return;

        var me = this;

        FB.init({
            appId  : BillsApp.app.facebookAppId,
            cookie : true
        });
    ...
    login: function() {
        ...
        if (!splash) {
            Ext.Viewport.add({ xclass: 'BillsApp.view.Login', id: 'login' });
        }
    ...
    onLogin: function() {
        ...
        FB.api('/me', function(response) {
            ...
            if (response.error) {
                ...
                BillsApp.userData = response;
                if (!me.main) {
                    me.main = Ext.create('BillsApp.view.Main', {
                        id: 'main'
                    });
                }
